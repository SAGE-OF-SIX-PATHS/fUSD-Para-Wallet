...
export function SignatureDisplay({ signature }: SignatureDisplayProps) {
  ...
  return (
    <div className="mt-6 w-full max-w-xl p-4 rounded-2xl bg-card shadow-glow text-center break-words">
      <h3 className="text-lg font-semibold text-accent-pink mb-2">Signature</h3>
